...
The installed Task 004 service and matching non-elevated desktop passed LocalService validation on 2026-09-18. The desktop displayed real System Health values, changed to Disconnected when the service stopped, and received a newer sample in the same process after service restart.
